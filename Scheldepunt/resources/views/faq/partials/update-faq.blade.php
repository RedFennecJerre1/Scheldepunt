<section class="space-y-6">
    <form method="POST" action="{{ route('faq.update', $faq) }}">
        ...
        <div>
            ...
            <x-text-input id="question" class="block w-full p-2 mb-4 border border-gray-300 rounded-md dark:text-gray-200 dark:border-gray-600 focus:outline-none focus:bg-white focus:border-blue-500" type="text" name="question" :value="old('question', $faq->question ?? 'No question')"  />
        ...
        <div>
            ...
            <x-text-input id="answer" class="block w-full p-2 mb-4 border border-gray-300 rounded-md dark:text-gray-200 dark:border-gray-600 focus:outline-none focus:bg-white focus:border-blue-500" type="text" name="answer" :value="old('answer', $faq->answer ?? 'No answer')"  />
